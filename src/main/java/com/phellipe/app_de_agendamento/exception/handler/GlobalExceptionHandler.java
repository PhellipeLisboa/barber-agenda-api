...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AppointmentOutOfWorkdayException.class)
    public ResponseEntity<ErrorResponse> handlerAppointmentOutOfWorkday(AppointmentOutOfWorkdayException ex, WebRequest request) {
        return buildResponse(ex, HttpStatus.BAD_REQUEST, request);
    }
    ...
    @ExceptionHandler(InvalidWorkdayRangeException.class)
    public ResponseEntity<ErrorResponse> handleInvalidWorkdayRange(InvalidWorkdayRangeException ex, WebRequest request) {
        return buildResponse(ex, HttpStatus.BAD_REQUEST, request);
    }
